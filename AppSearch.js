...
// ($OMARCHY_PATH/shell/services/AppSearch.js, MIT). Kept byte-identical below
// this header so a `diff` against the shipped file stays empty: AppLibrary.qml
// ranks and filters desktop entries with it, so the Apps submenu lists what
// the launcher lists, in the launcher's order, whether the rows came from the
// shell's application library or from ours.
